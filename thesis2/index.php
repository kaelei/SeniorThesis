...
<body>
  <div id="topnav">
    <h1 id="titlePage">SecondHand<img id ="header_img" src="images/second_hand.jpg" alt="Second Hand"/></h1>
    
    <button type="button" id="SignIn" onclick="signIn()">
      Sign In
    </button>
    <div id="card-div"  style="display:none">
    
      <h5 class="card-title" id="WelcomeMessage"  style="display:none" name="login">SignIn</h5>
      <div id="topnavLog">
        <ul id="navList">
          <li class="navItem">
  ...
  <hr>
  <p id="emailTest" style="display:none"></p>
